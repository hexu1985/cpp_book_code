...
{ 
  const collate<typename String::value_type>& collateFacet = 
                         use_facet< collate<typename String::value_type> >(loc); 
  String tmpOne =  
...
/* Input: No input
*/
/* Output: Please regard that the DOS - Box representation of ? is ?
